...
const INDICES = [
  { sym: 'SPY',  name: 'S&P 500',    flag: '🇺🇸' },
  { sym: 'QQQ',  name: 'NASDAQ',     flag: '🇺🇸' },
  { sym: 'EWQ',  name: 'CAC 40',     flag: '🇫🇷' },
  { sym: 'EWG',  name: 'DAX',        flag: '🇩🇪' },
  { sym: 'EWU',  name: 'FTSE 100',   flag: '🇬🇧' },
  { sym: 'EWJ',  name: 'Nikkei 225', flag: '🇯🇵' },
  { sym: 'EWH',  name: 'Hang Seng',  flag: '🇭🇰' },
];
